    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-950 px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur-2xl shadow-2xl relative z-10">
        <div className="text-center space-y-2 mb-8">
          ...
          <h2 className="text-2xl font-black text-white font-serif">Super Admin Login</h2>
          <p className="text-xs text-slate-400">Portal credentials to moderate owners, create hotels, and inspect logs.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-xs">
          <div className="space-y-1.5">
            <label className="block text-slate-350 font-bold">Admin Email</label>
        ...
        <div className="text-center pt-5 border-t border-white/5 space-y-2 mt-6">
          ...
          <div className="flex flex-wrap justify-center gap-x-2.5 gap-y-1.5 text-[10px] text-slate-400 font-semibold">
            ...
            <span>•</span>
            <button onClick={() => navigate('/login/superadmin')} className="text-amber-450 hover:text-white hover:underline cursor-pointer">Super Admin</button>
          </div>
        </div>
